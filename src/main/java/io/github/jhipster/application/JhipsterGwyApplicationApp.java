...
@EnableZuulProxy
public class JhipsterGwyApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterGwyApplicationApp.class);

    private final Environment env;

    public JhipsterGwyApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterGwyApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterGwyApplicationApp.class);
